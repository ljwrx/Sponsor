function sponsorCtrl($scope, $resource) {

    var loginService = $resource('../../Php/Sponsor/user.php/user/login');
    var registerService = $resource('../../Php/Sponsor/user.php/user/register');
    ...
    $scope.userRegister = function () {
        ...
        try {
            ...
            var requestParams = {
                ...
                registerCompanyname:$scope.companyname,
                registerLocation:$scope.location,
...
angular.module('sponsorsign',['ngResource']);